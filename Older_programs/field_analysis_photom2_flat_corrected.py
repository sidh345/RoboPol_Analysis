...
blazar_list = ['RBPLJ2015-0137','RBPLJ2016+1632','RBPLJ2016-0903','RBPLJ2022+7611']
...
def pol_measurement(blazar): 
    ...
    Data_Dir = "/media/user/Seagate Backup Plus Drive/DATA/RoboPol/Output_Data/" + blazar #+ "_flat_cr_corrected"
