...
blazar_list = ['RBPLJ1248+5820']   



def pol_measurement(blazar): 
    # input is Name of the target field eg. blazar = 'RBPLJ1048+7143' 
    ...
    Data_Dir = "/media/user/Seagate Backup Plus Drive/DATA/RoboPol/Flat_cr_photom2/" + blazar #+ "_flat_cr_corrected"
